...
<body style="background-color: black !important;">
	...
	<div class="container">
		<div class="card card-container">
			...
			<form class="form-signin" action="/netgfixweb/efetuaLogin"
				method="post">
				<span id="reauth-email" class="reauth-email"></span>
				<p class="input_title">Email</p>
				<input type="text" id="inputEmail" name="email" class="login_box"
				...
				<button class="btn btn-lg btn-primary" type="submit" style="background-color: red;">Entrar</button>
			</form>
		</div>
		<!-- /card-container -->
	</div>
